...
class EditBuddyState extends State<EditBuddy>{
  ...
  final CollectionReference buddyData1 = Firestore.instance.collection("buddy_1");
                      ...
                      child: new Column(
                          ...
                          children: <Widget>[
                            ...
                            new MaterialButton(
                              ...
                              onPressed: () {
                                  submitData(buddyName1.text,buddyMob1.text,buddyName2.text,buddyMob2.text);
